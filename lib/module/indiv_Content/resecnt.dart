...
import '../../provider/indi_account.dart/getResent.dart';

class RescentContent extends StatefulWidget {
  const RescentContent({Key? key}) : super(key: key);

  @override
  State<RescentContent> createState() => _RescentContentState();
}

class _RescentContentState extends State<RescentContent> {
  List<Recent>? contentModels;
  var isLoaded = false;
  ...
  getData() async {
    contentModels = (await RemoteService().getRescent()) as List<Recent>;
