...
class TechnologyChannelDataID extends StatefulWidget {
  String? contentID;
  TechnologyChannelDataID({Key? key, required this.contentID})
      : super(key: key);

  @override
  State<TechnologyChannelDataID> createState() =>
      _TechnologyChannelDataIDState();
}

class _TechnologyChannelDataIDState extends State<TechnologyChannelDataID> {
  ...
  getData() async {
    contentModels = (await RemoteService()
        .getChannelNewsContentByIdTechnology(widget.contentID!)) as List<News>;
