...
class HealthChannelDataByID extends StatefulWidget {
  String? contentID;
  HealthChannelDataByID({Key? key, required this.contentID}) : super(key: key);

  @override
  State<HealthChannelDataByID> createState() => _HealthChannelDataByIDState();
}

class _HealthChannelDataByIDState extends State<HealthChannelDataByID> {
  ...
  getData() async {
    contentModels = (await RemoteService()
        .getChannelNewsContentByIdHealth(widget.contentID!)) as List<News>;
