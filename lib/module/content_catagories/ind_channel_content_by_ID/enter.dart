...
class EntertementChannelDataByID extends StatefulWidget {
  String? contentID;
  EntertementChannelDataByID({Key? key, required this.contentID})
      : super(key: key);

  @override
  State<EntertementChannelDataByID> createState() => _EntertementChanneState();
}

class _EntertementChanneState extends State<EntertementChannelDataByID> {
  ...
  getData() async {
    contentModels = (await RemoteService()
            .getChannelNewsContentByIdEntertainment(widget.contentID!))
        as List<News>;
