...
class PoliticsChannelDataByID extends StatefulWidget {
  String? contentID;
  PoliticsChannelDataByID({Key? key, required this.contentID})
      : super(key: key);

  @override
  State<PoliticsChannelDataByID> createState() =>
      _PoliticsChannelDataByIDState();
}

class _PoliticsChannelDataByIDState extends State<PoliticsChannelDataByID> {
  ...
  getData() async {
    contentModels = (await RemoteService()
        .getChannelNewsContentByIdPolitics(widget.contentID!)) as List<News>;
