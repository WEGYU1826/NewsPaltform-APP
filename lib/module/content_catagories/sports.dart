...
import 'package:zena/provider/news_catagories/SportContent.dart';

import '../../model/news_model.dart';

class SportCatagories extends StatefulWidget {
  const SportCatagories({Key? key}) : super(key: key);

  @override
  State<SportCatagories> createState() => _SportCatagoriesState();
}

class _SportCatagoriesState extends State<SportCatagories> {
  ...
  getData() async {
    contentModels = (await RemoteService().getSportNewsContent()) as List<News>;
