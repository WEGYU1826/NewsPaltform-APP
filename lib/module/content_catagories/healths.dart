...
import 'package:zena/provider/news_catagories/HealthContent.dart';

import '../../model/news_model.dart';

class HealthCatagories extends StatefulWidget {
  const HealthCatagories({Key? key}) : super(key: key);

  @override
  State<HealthCatagories> createState() => _HealthCatagoriesState();
}

class _HealthCatagoriesState extends State<HealthCatagories> {
  ...
  getData() async {
    contentModels =
        (await RemoteService().getHealthNewsContent()) as List<News>;
