...
class PoliticsCatagories extends StatefulWidget {
  const PoliticsCatagories({Key? key}) : super(key: key);
  static const String id = "politics_catagories";

  @override
  State<PoliticsCatagories> createState() => _PoliticsCatagoriesState();
}

class _PoliticsCatagoriesState extends State<PoliticsCatagories> {
  ...
  getData() async {
    contentModels =
        (await RemoteService().getPoliticsNewsContent()) as List<News>;
