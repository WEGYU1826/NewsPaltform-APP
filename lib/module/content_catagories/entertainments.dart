...
import 'package:zena/provider/news_catagories/EntertainmentsContent.dart';

import '../../model/news_model.dart';

class EntertaimentCatagories extends StatefulWidget {
  const EntertaimentCatagories({Key? key}) : super(key: key);

  @override
  State<EntertaimentCatagories> createState() => _EntertaimentCatagoriesState();
}

class _EntertaimentCatagoriesState extends State<EntertaimentCatagories> {
  ...
  getData() async {
    contentModels =
        (await RemoteService().getEntertainmentNewsContent()) as List<News>;
